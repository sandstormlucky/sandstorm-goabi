...
func (_Tc *TcCaller) HashLeftRight(opts *bind.CallOpts, _left [32]byte, _right [32]byte) ([32]byte, error) {
	var out []interface{}
	err := _Tc.contract.Call(opts, &out, "hashLeftRight", _left, _right)
...
//
// Solidity: function hashLeftRight(bytes32 _left, bytes32 _right) view returns(bytes32)
func (_Tc *TcSession) HashLeftRight(_left [32]byte, _right [32]byte) ([32]byte, error) {
	return _Tc.Contract.HashLeftRight(&_Tc.CallOpts, _left, _right)
}

// HashLeftRight is a free data retrieval call binding the contract method 0x38bf282e.
//
// Solidity: function hashLeftRight(bytes32 _left, bytes32 _right) view returns(bytes32)
func (_Tc *TcCallerSession) HashLeftRight(_left [32]byte, _right [32]byte) ([32]byte, error) {
	return _Tc.Contract.HashLeftRight(&_Tc.CallOpts, _left, _right)
}
...
func (_Tc *TcCaller) Zeros(opts *bind.CallOpts, arg0 *big.Int) ([32]byte, error) {
	var out []interface{}
	err := _Tc.contract.Call(opts, &out, "zeros", arg0)
...
//
// Solidity: function zeros(uint256 ) view returns(bytes32)
func (_Tc *TcSession) Zeros(arg0 *big.Int) ([32]byte, error) {
	return _Tc.Contract.Zeros(&_Tc.CallOpts, arg0)
}

// Zeros is a free data retrieval call binding the contract method 0xe8295588.
//
// Solidity: function zeros(uint256 ) view returns(bytes32)
func (_Tc *TcCallerSession) Zeros(arg0 *big.Int) ([32]byte, error) {
	return _Tc.Contract.Zeros(&_Tc.CallOpts, arg0)
}
...
func (_Tc *TcTransactor) Withdraw(opts *bind.TransactOpts, a [2]*big.Int, b [2][2]*big.Int, c [2]*big.Int, input [6]*big.Int, _root [32]byte, _nullifierHash [32]byte, _recipient common.Address, _relayer common.Address, _fee *big.Int, _refund *big.Int) (*types.Transaction, error) {
	return _Tc.contract.Transact(opts, "withdraw", a, b, c, input, _root, _nullifierHash, _recipient, _relayer, _fee, _refund)
}

// Withdraw is a paid mutator transaction binding the contract method 0xa0c88a25.
//
// Solidity: function withdraw(uint256[2] a, uint256[2][2] b, uint256[2] c, uint256[6] input, bytes32 _root, bytes32 _nullifierHash, address _recipient, address _relayer, uint256 _fee, uint256 _refund) payable returns()
func (_Tc *TcSession) Withdraw(a [2]*big.Int, b [2][2]*big.Int, c [2]*big.Int, input [6]*big.Int, _root [32]byte, _nullifierHash [32]byte, _recipient common.Address, _relayer common.Address, _fee *big.Int, _refund *big.Int) (*types.Transaction, error) {
	return _Tc.Contract.Withdraw(&_Tc.TransactOpts, a, b, c, input, _root, _nullifierHash, _recipient, _relayer, _fee, _refund)
}

// Withdraw is a paid mutator transaction binding the contract method 0xa0c88a25.
//
// Solidity: function withdraw(uint256[2] a, uint256[2][2] b, uint256[2] c, uint256[6] input, bytes32 _root, bytes32 _nullifierHash, address _recipient, address _relayer, uint256 _fee, uint256 _refund) payable returns()
func (_Tc *TcTransactorSession) Withdraw(a [2]*big.Int, b [2][2]*big.Int, c [2]*big.Int, input [6]*big.Int, _root [32]byte, _nullifierHash [32]byte, _recipient common.Address, _relayer common.Address, _fee *big.Int, _refund *big.Int) (*types.Transaction, error) {
	return _Tc.Contract.Withdraw(&_Tc.TransactOpts, a, b, c, input, _root, _nullifierHash, _recipient, _relayer, _fee, _refund)
}
...
func (_Tc *TcFilterer) FilterDeposit(opts *bind.FilterOpts, commitments [][32]byte) (*TcDepositIterator, error) {
	...
	logs, sub, err := _Tc.contract.FilterLogs(opts, "Deposit", commitmentsRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Deposit(bytes32 indexed commitments, uint32 leafIndex, uint256 timestamp)
func (_Tc *TcFilterer) WatchDeposit(opts *bind.WatchOpts, sink chan<- *TcDeposit, commitments [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _Tc.contract.WatchLogs(opts, "Deposit", commitmentsRule)
	if err != nil {
		return nil, err
	}
